...
`, k = (p, s) => {
  ...
  mount(p, s) {
    ...
    const g = async (t, o) => {
      ...
      try {
        d(k(t, o));
        const { setApiTransport: i } = await import("./client-xgtajoHc.js");
        i(w()), e.hidden = !0, n = !1;
      } catch (i) {
    ...
    return e.querySelector("#lan-host").addEventListener("click", () => {
      ...
      n || (n = !0, b.textContent = "Starting LAN host…", (async () => {
        try {
          ...
          const { setApiTransport: o } = await import("./client-xgtajoHc.js");
      ...
      T(async () => {
        const { setApiTransport: h } = await import("./client-xgtajoHc.js");
        h(C((E) => c.fetch(E), i));
      });
    }), () => {
      L(), e.remove(), r.remove();

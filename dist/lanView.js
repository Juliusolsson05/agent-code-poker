...
`, k = (p, a) => {
  ...
  mount(p, a) {
    ...
    const g = async (t, o) => {
      ...
      try {
        l(k(t, o));
        const { setApiTransport: i } = await import("./client-CfWOXKHq.js");
        i(w()), e.hidden = !0, n = !1;
      } catch (i) {
    ...
    return e.querySelector("#lan-host").addEventListener("click", () => {
      ...
      n || (n = !0, b.textContent = "Starting LAN host…", (async () => {
        try {
          ...
          const { setApiTransport: o } = await import("./client-CfWOXKHq.js");
      ...
      S(async () => {
        const { setApiTransport: h } = await import("./client-CfWOXKHq.js");
        h(C((T) => c.fetch(T), i));
      });
    }), () => {
      L(), e.remove(), s.remove();

...
and the reason is shown. Sound Off (M) silences voices too. The Treats switch
is carried to every client now; it hides and refuses treats once the treat
menu from the drinks work reaches LAN play. Live ElevenLabs speech has not yet
